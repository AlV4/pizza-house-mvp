...
final class CookingOrderIdTest extends TestCase
{
    ...
    public function test_accepts_a_lowercase_ulid(): void
    {
        ...
        $id = new CookingOrderId($lowercase);
    ...
    public function test_rejects_a_ulid_of_the_wrong_length(): void
    {
        ...
        new CookingOrderId('01HZX9P3K8Q7R6S5T4V3W2X1Y');
    }
    ...
    public function test_rejects_a_ulid_whose_leading_character_exceeds_seven(): void
    {
        ...
        new CookingOrderId('81HZX9P3K8Q7R6S5T4V3W2X1Y0');
    }

    public function test_equals_is_true_for_the_same_value(): void
    {
        $a = new CookingOrderId(self::VALID_ULID);
        $b = new CookingOrderId(self::VALID_ULID);
    ...
    {
        $a = new CookingOrderId(self::VALID_ULID);
        $b = new CookingOrderId('01HZX9P3K8Q7R6S5T4V3W2X1Y1');
